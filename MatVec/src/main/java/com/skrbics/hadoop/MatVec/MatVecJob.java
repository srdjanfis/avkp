...
public class MatVecJob {
	public static void main(String[] args) throws Exception {
		JobClient my_client = new JobClient();
		JobConf job_conf = new JobConf(MatVecJob.class);

		job_conf.setOutputKeyClass(IntWritable.class);
		job_conf.setOutputValueClass(Text.class);

		job_conf.setMapperClass(MatVecMapper.class);
		job_conf.setReducerClass(MatVecReducer.class);
